...
const OrderItem = ({order}: OrderItemProps) => {
    return (
        <Box>
            <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-6 px-4 py-2 
            rounded-md border border-gray-100">
                ...
                <p className={cn("text-base font-semibold", order.order_status === "Delivering" && "text-yellow-500" ||
